...
<body>
    ...
    <form method="POST">
        ...
        <input typr="number" name="primeiroNumero" id="primeiroNumero">
        <br><br>
        <label>Segundo número: </label>
        <input typr="number" name="segundoNumero" id="segundoNumero">
        <br><br>
        <label>Número de busca: </label>
        <input typr="number" name="terceiroNumero" id="terceiroNumero">
        <br><br>
